...
public class InitialSetupDaoImpl implements InitialSetupDao {
    ...
    public void createUserAccountTable() {
        String createTableQuery = "CREATE TABLE user_accounts (account_number BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 10000000)," +
        ...
        try (Connection connection = DatabaseConnector.getConnection(); PreparedStatement statement = connection.prepareStatement(createTableQuery)) {
            statement.execute();
    ...
    public void createTransactionTable() {
        String createTableQuery = "CREATE TABLE transactions (transaction_id INT NOT NULL AUTO_INCREMENT, status VARCHAR(20), " +
